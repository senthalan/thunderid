...
func (_mock *UserServiceInterfaceMock) CreateUser(u *user.User) (*user.User, *serviceerror.ServiceError) {
	ret := _mock.Called(u)
...
func (_c *UserServiceInterfaceMock_CreateUser_Call) Run(run func(user *user.User)) *UserServiceInterfaceMock_CreateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *user.User
		if args[0] != nil {
...
func (_c *UserServiceInterfaceMock_CreateUser_Call) Return(user1 *user.User, serviceError *serviceerror.ServiceError) *UserServiceInterfaceMock_CreateUser_Call {
	_c.Call.Return(user1, serviceError)
	return _c
}

func (_c *UserServiceInterfaceMock_CreateUser_Call) RunAndReturn(run func(user *user.User) (*user.User, *serviceerror.ServiceError)) *UserServiceInterfaceMock_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserServiceInterfaceMock_CreateUserByPath_Call) Return(user *user.User, serviceError *serviceerror.ServiceError) *UserServiceInterfaceMock_CreateUserByPath_Call {
...
func (_c *UserServiceInterfaceMock_GetUser_Call) Return(user *user.User, serviceError *serviceerror.ServiceError) *UserServiceInterfaceMock_GetUser_Call {
	_c.Call.Return(user, serviceError)
	return _c
}
...
func (_mock *UserServiceInterfaceMock) UpdateUser(userID string, u *user.User) (*user.User, *serviceerror.ServiceError) {
	ret := _mock.Called(userID, u)
...
func (_c *UserServiceInterfaceMock_UpdateUser_Call) Run(run func(userID string, user *user.User)) *UserServiceInterfaceMock_UpdateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *UserServiceInterfaceMock_UpdateUser_Call) Return(user1 *user.User, serviceError *serviceerror.ServiceError) *UserServiceInterfaceMock_UpdateUser_Call {
	_c.Call.Return(user1, serviceError)
	return _c
}

func (_c *UserServiceInterfaceMock_UpdateUser_Call) RunAndReturn(run func(userID string, user *user.User) (*user.User, *serviceerror.ServiceError)) *UserServiceInterfaceMock_UpdateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserServiceInterfaceMock_VerifyUser_Call) Return(user *user.User, serviceError *serviceerror.ServiceError) *UserServiceInterfaceMock_VerifyUser_Call {
	_c.Call.Return(user, serviceError)
	return _c
}
