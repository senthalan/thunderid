...
func (_mock *FlowFactoryInterfaceMock) CloneNode(source core.NodeInterface) (core.NodeInterface, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(core.NodeInterface) (core.NodeInterface, error)); ok {
		return returnFunc(source)
	}
	if returnFunc, ok := ret.Get(0).(func(core.NodeInterface) core.NodeInterface); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(core.NodeInterface) error); ok {
...
func (_c *FlowFactoryInterfaceMock_CloneNode_Call) Run(run func(source core.NodeInterface)) *FlowFactoryInterfaceMock_CloneNode_Call {
...
func (_c *FlowFactoryInterfaceMock_CloneNode_Call) Return(nodeInterface core.NodeInterface, err error) *FlowFactoryInterfaceMock_CloneNode_Call {
	_c.Call.Return(nodeInterface, err)
	return _c
}

func (_c *FlowFactoryInterfaceMock_CloneNode_Call) RunAndReturn(run func(source core.NodeInterface) (core.NodeInterface, error)) *FlowFactoryInterfaceMock_CloneNode_Call {
	_c.Call.Return(run)
	return _c
}

// CloneNodes provides a mock function for the type FlowFactoryInterfaceMock
func (_mock *FlowFactoryInterfaceMock) CloneNodes(nodes map[string]core.NodeInterface) (map[string]core.NodeInterface, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(map[string]core.NodeInterface) (map[string]core.NodeInterface, error)); ok {
		return returnFunc(nodes)
	}
	if returnFunc, ok := ret.Get(0).(func(map[string]core.NodeInterface) map[string]core.NodeInterface); ok {
		r0 = returnFunc(nodes)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(map[string]core.NodeInterface) error); ok {
		r1 = returnFunc(nodes)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *FlowFactoryInterfaceMock_CloneNodes_Call) Run(run func(nodes map[string]core.NodeInterface)) *FlowFactoryInterfaceMock_CloneNodes_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *FlowFactoryInterfaceMock_CloneNodes_Call) Return(stringToNodeInterface map[string]core.NodeInterface, err error) *FlowFactoryInterfaceMock_CloneNodes_Call {
	_c.Call.Return(stringToNodeInterface, err)
	return _c
}

func (_c *FlowFactoryInterfaceMock_CloneNodes_Call) RunAndReturn(run func(nodes map[string]core.NodeInterface) (map[string]core.NodeInterface, error)) *FlowFactoryInterfaceMock_CloneNodes_Call {
	_c.Call.Return(run)
	return _c
}

// CreateExecutor provides a mock function for the type FlowFactoryInterfaceMock
func (_mock *FlowFactoryInterfaceMock) CreateExecutor(name string, executorType common.ExecutorType, defaultInputs []common.Input, prerequisites []common.Input) core.ExecutorInterface {
	...
	if returnFunc, ok := ret.Get(0).(func(string, common.ExecutorType, []common.Input, []common.Input) core.ExecutorInterface); ok {
...
func (_c *FlowFactoryInterfaceMock_CreateExecutor_Call) Return(executorInterface core.ExecutorInterface) *FlowFactoryInterfaceMock_CreateExecutor_Call {
	_c.Call.Return(executorInterface)
	return _c
}

func (_c *FlowFactoryInterfaceMock_CreateExecutor_Call) RunAndReturn(run func(name string, executorType common.ExecutorType, defaultInputs []common.Input, prerequisites []common.Input) core.ExecutorInterface) *FlowFactoryInterfaceMock_CreateExecutor_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FlowFactoryInterfaceMock_CreateGraph_Call) Return(graphInterface core.GraphInterface) *FlowFactoryInterfaceMock_CreateGraph_Call {
...
func (_c *FlowFactoryInterfaceMock_CreateNode_Call) Return(nodeInterface core.NodeInterface, err error) *FlowFactoryInterfaceMock_CreateNode_Call {
	_c.Call.Return(nodeInterface, err)
	return _c
}
