...
func (_c *FlowMetaServiceInterfaceMock_GetFlowMetadata_Call) Return(flowMetadataResponse *flowmeta.FlowMetadataResponse, serviceError *serviceerror.ServiceError) *FlowMetaServiceInterfaceMock_GetFlowMetadata_Call {
