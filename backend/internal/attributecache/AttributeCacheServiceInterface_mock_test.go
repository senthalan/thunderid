...
func (_mock *AttributeCacheServiceInterfaceMock) CreateAttributeCache(ctx context.Context, cache *AttributeCache) (*AttributeCache, *serviceerror.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, *AttributeCache) (*AttributeCache, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, cache)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *AttributeCache) *AttributeCache); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *AttributeCache) *serviceerror.ServiceError); ok {
...
func (_c *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call) Run(run func(ctx context.Context, cache *AttributeCache)) *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call {
...
func (_c *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call) Return(attributeCache *AttributeCache, serviceError *serviceerror.ServiceError) *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call {
	_c.Call.Return(attributeCache, serviceError)
	return _c
}

func (_c *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call) RunAndReturn(run func(ctx context.Context, cache *AttributeCache) (*AttributeCache, *serviceerror.ServiceError)) *AttributeCacheServiceInterfaceMock_CreateAttributeCache_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *AttributeCacheServiceInterfaceMock) GetAttributeCache(ctx context.Context, id string) (*AttributeCache, *serviceerror.ServiceError) {
	ret := _mock.Called(ctx, id)
	...
	var r0 *AttributeCache
	var r1 *serviceerror.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (*AttributeCache, *serviceerror.ServiceError)); ok {
...
func (_c *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call) Return(attributeCache *AttributeCache, serviceError *serviceerror.ServiceError) *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call {
	_c.Call.Return(attributeCache, serviceError)
	return _c
}

func (_c *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call) RunAndReturn(run func(ctx context.Context, id string) (*AttributeCache, *serviceerror.ServiceError)) *AttributeCacheServiceInterfaceMock_GetAttributeCache_Call {
	_c.Call.Return(run)
	return _c
}
