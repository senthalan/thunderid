...
func (_c *InboundClientServiceInterfaceMock_GetCertificate_Call) Return(certificate *model.Certificate, certOperationError *CertOperationError) *InboundClientServiceInterfaceMock_GetCertificate_Call {
